<?php
require 'gizi_buruk.php';

$conn = mysqli_connect("localhost", "root", "", "stunting");
...
function tambah($data_tambah)
{
    ...
    $query = "INSERT INTO data_user
                        VALUES 
                ('','$nama_ayah','$nama_ibu','$nama_anak','$usia_anak','$tinggi_badan_anak','$berat_badan_anak','$jenis_kelamin_anak','$waktu','$tketerangan','$id_data_user')";
